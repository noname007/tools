...
class RestError {
    ...
    const SEVENGA_ERROR_TG_LOG_TOO_LATE_ERROR = -7001;
    const SEVENGA_ERROR_TG_LOG_SAVE_ERROR = -7002;
    const SEVENGA_ERROR_TG_NO_INFO_ERROR = -7003;
    const SEVENGA_ERROR_TG_NO_LOG_ERROR = -7004;
